 ...
 * 
 * import com.cognologix.security.JwtTokenUtil; import
 ...
 * IOException { request.getUserPrincipal();
 * 
 * String username = null; String jwtToken = null;
 * 
 * final String requestTokenHeader = request.getHeader("Authorization"); if
